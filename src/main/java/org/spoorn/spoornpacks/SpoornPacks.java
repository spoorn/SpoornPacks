...
//
//        RegistryKey<ItemGroup> myItemGroup = RegistryKey.of(RegistryKeys.ITEM_GROUP, new Identifier(modid, "general"));
//        ItemGroup itemGroup = Registry.register(Registries.ITEM_GROUP, myItemGroup, FabricItemGroup.builder()
//                .displayName(Text.translatable("spoornpacks.itemGroup.displayName"))
//                .icon(ResourceFactory.fetchItemGroupSupplierFromBlock(modid, "pink_blossom_sapling"))
//                .build());
//
